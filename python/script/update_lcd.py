...
try:
    ...
    while True:
        ...
        draw.text((10, 180),    "ID",            fill="GRAY", font=Font4)
        draw.text((50, 180),    device_id,       fill="GREEN", font=Font4)

        draw.text((10, 205),    "VER",           fill="GRAY", font=Font4)
        draw.text((50, 205),    ndpi_version,    fill="GREEN", font=Font4)
