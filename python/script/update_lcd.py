...
try:
    ...
    while True:
        ...
        draw.text((10, 112),    "NDI:",          fill="GRAY", font=Font4)
        draw.text((60, 110),    ndpi_status_ndi, fill="GREEN", font=Font3)
        draw.text((60, 135),    target_src,      fill="GREEN", font=Font4)
        draw.text((15, 187),    "ID:",           fill="GRAY", font=Font4)
        draw.text((50, 185),    device_id,       fill="GREEN", font=Font3)
        draw.text((20, 207),    "VER:",          fill="GRAY", font=Font4)
        draw.text((50, 205),    ndpi_version,    fill="GREEN", font=Font3)
