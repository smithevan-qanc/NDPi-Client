...
public:
    NDIReceiver(
        ...
        const std::string &scale_method_arg = "bilinear") : bandwidth_setting(bandwidth), color_format_setting(color_format), use_framesync(enable_framesync), scale_method(scale_method_arg)
    {
        // NDIReceiver() {
    ...
    ~NDIReceiver()
    {
        stop();
        if (ndi_recv)
            g_ndi.recv_destroy(ndi_recv);
        if (ndi_framesync)
            g_ndi.framesync_destroy(ndi_framesync);
        if (main_loop)
...
int main(int argc, char *argv[])
{
    ...
    for (int i = 1; i < argc; ++i)
    {
        ...
        else if (arg == "-h" || arg == "--help")
        {
            ...
            std::cout << "    [-b|--bandwidth [<OPTION>]] ------ Bandwidth ENUM. [OPTIONS]:                 " << "\n";
            std::cout << "                                         '-10'                  -> metadata_only  " << "\n";
            std::cout << "                                         '10'                   -> audio_only     " << "\n";
            std::cout << "                                         '0'                    -> lowest         " << "\n";
            std::cout << "                                         '100'                  -> highest        " << "\n";
            std::cout << "                                         '0x7fffffff' (Default) -> max            " << "\n";
            std::cout << "    [-c|--color-format [<OPTION>]] --- Color Format ENUM. [OPTIONS]:              " << "\n";
            std::cout << "                                         '0'                    -> BGRX_BGRA      " << "\n";
            std::cout << "                                         '1'                    -> UYVY_BGRA      " << "\n";
            std::cout << "                                         '2'                    -> RGBX_RGBA      " << "\n";
            std::cout << "                                         '3'                    -> UYVY_RGBA      " << "\n";
            std::cout << "                                         '100' (Default)        -> fastest        " << "\n";
            std::cout << "                                         '101'                  -> best           " << "\n";
            std::cout << "    [-S|--scale-method [<OPTION>]] --- GStreamer videoscale method. [OPTIONS]:    " << "\n";
            std::cout << "                                         'nearest'                                " << "\n";
            std::cout << "                                         'linear'                                 " << "\n";
            std::cout << "                                         'cubic'                                  " << "\n";
            std::cout << "                                         'lanczos'                                " << "\n";
            std::cout << "                                         'bilinear' (Default)                     " << "\n";
